...
// 上面是之前的用法，下面为了测试动态生成inline class，省略了groupHoverIcon和isActiveIcon
const routes = [
  {
    path: "/",
    redirect: "/Intro",
    meta: {
      icon: "i-carbon-book",
      hoverIcon: "i-carbon-face-satisfied",
      topic: "前言",
      menuShow: false,
    },
  },
  {
    ...
    meta: {
      icon: "i-carbon-book",
      hoverIcon: "i-carbon-notebook-reference",
      topic: "前言",
      menuShow: true,
    },
  },
  {
    ...
    meta: {
      ...
      hoverIcon: "i-carbon-ibm-toolchain",
      topic: "高可定制",
      menuShow: true,
    },
  },
  ...
  },
  {
    path: "/Attributify",
    name: "Attributify",
    component: Attributify,
    meta: {
      icon: "i-carbon-code",
      hoverIcon: "i-carbon-code",
      topic: "属性化模式",
      menuShow: true,
    },
  },
  ...
  },
  {
    ...
    meta: {
      ...
      hoverIcon: "i-carbon-group-objects",
      topic: "组合缩写",
      menuShow: true,
    },
  },
  {
    path: "/CSSDirectives",
    name: "CSSDirectives",
    component: CSSDirectives,
    meta: {
      icon: "i-carbon-at",
      hoverIcon: "i-carbon-at",
      topic: "CSS指令",
      menuShow: true,
    },
  },
  {
    ...
    meta: {
      ...
      hoverIcon: "i-carbon-tree-view-alt",
      topic: "编译模式",
      menuShow: true,
    },
  },
  ...
  },
  {
    ...
    component: Thinkings,
    meta: {
      icon: "i-carbon-face-dizzy-filled",
      hoverIcon: "i-carbon-user-favorite",
      topic: "个人思考",
      menuShow: true,
    },
  },
